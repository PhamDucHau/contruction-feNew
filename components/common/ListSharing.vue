<template>
  <div class="addThis_listSharing addThis_listing is-show">
    <div class="addThis_item">
      <a href="#" class="addThis_item-icon" title="">
        <v-btn color="red-darken-1" icon="mdi-phone"></v-btn>
        <span class="tooltip-text">Gọi ngay cho chúng tôi </span>
      </a>
      <br />
      <a href="#" class="addThis_item-icon mt-2" title="">
        <svg
          width="44"
          height="44"
          viewBox="0 0 44 44"
      ...
      <a
        ...
        href="mailto:ndtheme95@gmail.com"
        aria-label="email"
        ...
        >
          ...
          <defs>
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset="50%" stop-color="#22e7f9"></stop>
              <stop offset="100%" stop-color="#03d2e4"></stop>
            </linearGradient>
          </defs>
        </svg>
